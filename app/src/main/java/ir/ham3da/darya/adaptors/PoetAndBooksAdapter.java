...
public abstract class PoetAndBooksAdapter<T extends PoetAndBooksAdapter.ListItem> extends RecyclerView.Adapter<PoetAndBooksAdapter.ViewHolder> {
    protected Context mContext;
    protected List<T> allItems = new ArrayList<>();

   // protected List<T> allItemsID = new ArrayList<>();
    ...
    public PoetAndBooksAdapter(Context context)
    {
        mContext = context;
    ...
    public static class ListItem
    {
        ...
        public ListItem(int itemType, int itemID, int child_Count,int poet_Index, int parentID ) {
    ...
    public void expandItems(int position, boolean notify)
    {
        ...
        mRecyclerView.getLayoutManager().smoothScrollToPosition(mRecyclerView, new RecyclerView.State(), allItems.get(index).poetIndex);

        //Log.d("parent", "pid: "+ allItems.get(index).ItemID+" , pos:"+ index+", poet index: "+ allItems.get(index).poetIndex);
    }
